...
| transition         | String                     | `bounce`        | Name of the [Vue Transition](https://vuejs.org/v2/guide/transitions.html) to use. Only `enter-active`, `leave-active` and `move` are applied.         |
